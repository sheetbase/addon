...
import {fetchGet} from './fetch.service';
import {getContentFolderChild} from './project.service';
import {getSheet, getData, setData} from './sheets.service';
import {isUrl, isJsonString} from './helper.service';
...
export function saveContent(
  ...
  if (setMode === 'RAW') {
    ...
    // configs
    const {autoloadedScheme, webhookEvent, mimeType, fileExt} = EDITOR_CONFIGS[
      editor
    ];
