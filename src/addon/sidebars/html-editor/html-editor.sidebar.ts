...
tinymce.init({
  ...
  height: 500,
  skin_url:
    'https://cdnjs.cloudflare.com/ajax/libs/tinymce/5.0.14/skins/ui/oxide',
  content_css: [
...
const app = new Vue({
  ...
  created() {
    ...
    google.script.run
      .withSuccessHandler<ProjectSettings>(
        settings => (this.hasWebHook = !!settings['WEBHOOK_URL'])
      )
      .getProjectSettings();
  },
